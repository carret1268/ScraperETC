...
This project is released under [CC0 (public domain)](https://github.com/carret1268/ScraperETC/blob/main/LICENSE). You are free to use, modify, and redistribute it without restriction.
